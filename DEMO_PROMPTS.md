# NimbusCloud Helpdesk Agent — Demo Prompts
...
> How do I troubleshoot VPN connectivity issues when accessing NimbusCloud?

> What are the steps for setting up multi-factor authentication with NimbusID?

> How does NimbusVault file permission inheritance work after a workspace migration?

> What are the API rate limits for NimbusAPI REST endpoints?

---

## 2. KB + Forum Cross-Reference

> A user says their VPN connection keeps timing out with 504 errors when trying to reach NimbusCloud. What should I tell them?

> An admin is preparing for a Section 508 accessibility audit. What resources do we have?

> We need to do a bulk workspace clone of 200+ NimbusBoard workspaces for the new quarter. Any tips or known issues?
...
> I'm helping customer 100030. They're reporting that NimbusConnect audio drops every 15-20 seconds when using Bluetooth headsets. It's affecting about 30 employees. Can we create a high priority case for this?
...
> Customer 100030 is asking about NimbusDocs offline sync errors after a long flight. Can you check the knowledge base for guidance and see if they already have a case open for this?
...
- **Knowledge base**: 15 articles covering NimbusHub, NimbusConnect, NimbusDocs, NimbusBoard, NimbusVault, NimbusID, NimbusAdmin, and NimbusAPI
